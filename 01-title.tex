...
\ThesisTitle{Minimally Invasive Flexible Needle Manipulation for Image-Agnostic Percutaneous Interventions}

\vspace{1in}                    % gap between the title and the author: approx. 1 inch

\ThesisAuthor{Yanzhou Wang}         % author name for the thesis
...
\ThesisDate{April}{2025}        % thesis submission month and year (single-spaced)
...
\ThesisCopyright{2025}{Yanzhou Wang}
