...
\Title{Autonomous Flexible Needle Manipulations for Image-Agnostic Percutaneous Needle Interventions}
\Author{Yanzhou Wang}
\end{filecontents*}
...
% \def\BibFileName{bibliography.bib}
% name of BibLaTeX-compatible bib file 
\def\BibFileName{auto_bibliography.bib}
...
\usepackage{amssymb,amsmath,amsthm,autobreak,
    cancel,mathtools,mathrsfs,siunitx}


%%%% TABLE-RELATED PACKAGES
\usepackage{booktabs,longtable,dcolumn,makecell,
    multicol,multirow,tabularx,rotating}
...
% \usepackage[backend=bibtex, defernumbers=true, style=nature, maxnames=99,
%      date=year, isbn=false, url=false, doi=true]{biblatex}

%% APA style
% \usepackage[backend=bibtex, defernumbers=true, style=apa, maxnames=99,
%     isbn=false, url=false, doi=true]{biblatex}

%% IEEE style
\usepackage[backend=bibtex,style=ieee,defernumbers=true,maxnames=99, 
    date=year, isbn=false, url=false, doi=true]{biblatex}
...
\usepackage{colorprofiles}                  % to generate PDF/A file (add before hyperref)
\usepackage[a-1b,mathxmp]{pdfx}             % to generate PDF/A file (add before hyperref)
...
\usepackage[final, highlightmarkup=background, commandnameprefix=ifneeded]{changes} % change to final after draft is approved
\definechangesauthor[name=Iulian Iordachita, color=red]{ii}
\definechangesauthor[name=Axel Krieger, color=magenta]{ak}
\definechangesauthor[name=Russell Taylor, color=brown]{rt}
...
\DeclareMathOperator{\ad}{Ad}       % Ad Lie operator
\DeclareMathOperator{\mnull}{\mathcal{N}}       % null
...
%%%%%%%%%%%%%%%%%%%%%%%%%%% END BACK MATTER %%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\listofchanges[style=list, title={Summary of Changes}]
\end{document}
