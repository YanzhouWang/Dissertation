...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.65\columnwidth]{figures/rcm_vs_com.png}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width = \textwidth]{figures/needle_tissue_rcm.png}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width = \columnwidth]{figures/T1T2_sim.png}
